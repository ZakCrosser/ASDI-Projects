var displayCouchData = function(){
	$.ajax({
		"url": "_view/transactions",
		"dataType": "json",
		"success": function(data) {
			$.each(data.rows, function(index, transactions) {
				var id = transactions.id
				var date = transactions.value.date;
				var transType = transactions.value.transType;
				var category = transactions.value.category;
				var amount = transactions.value.amount;
				var notes = transactions.value.notes;
				var checkBox = transactions.value.checkBox;
				$("#storedTransactions").append(
					$("<li>").append(
						$("<a>").attr("href", "#")
							.text(id)
					)
